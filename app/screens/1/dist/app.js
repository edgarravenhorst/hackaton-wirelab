...
var circularMotion = function circularMotion(selector, time, rad) {
  var repeat = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;

  var tl = new _gsap.TimelineMax({ repeat: repeat, repeatDelay: 0, delay: 0 });
  tl.to(selector, time, {
    bezier: {
      type: "quadratic",
      values: [{ x: 0, y: 0 }, { x: rad, y: 0 }, { x: rad, y: rad }, { x: rad, y: rad * 2 }, { x: 0, y: rad * 2 }, { x: -rad, y: rad * 2 }, { x: -rad, y: rad }, { x: -rad, y: 0 }, { x: 0, y: 0 }],
      autoRotate: false
    },
...
_gsap.TweenMax.to("#zon", 1, { scaleX: 1.4, scaleY: 1.4, repeat: -1, yoyo: true, ease: Linear.easeNone });
_gsap.TweenMax.to("#maan", 5, { scaleX: 1.1, scaleY: 1.1, repeat: -1, yoyo: true, ease: Linear.easeNone });
...
var Parallax = __webpack_require__(6);
